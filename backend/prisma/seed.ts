...
async function main() {
  ...
  const maria = await prisma.usuario.create({
    data: {
      ...
      avatar: 'https://images.unsplash.com/photo-1615464670798-6e92fafa2a89?w=400',
  ...
  const carlos = await prisma.usuario.create({
    data: {
      ...
      avatar: 'https://images.unsplash.com/photo-1616235931438-f67c5caed868?w=400',
  ...
  const ana = await prisma.usuario.create({
    data: {
      ...
      avatar: 'https://images.unsplash.com/photo-1640557443065-cd2b7ed858d6?w=400',
  ...
  const diego = await prisma.usuario.create({
    data: {
      ...
      avatar: 'https://images.unsplash.com/photo-1649354680299-ed0d7c3cb786?w=400',
  ...
  const laura = await prisma.usuario.create({
    data: {
      ...
      avatar: 'https://images.unsplash.com/photo-1644313720910-9a2520bbd28f?w=400',
  ...
  const sofia = await prisma.usuario.create({
    data: {
      ...
      avatar: 'https://images.unsplash.com/photo-1628439697786-3351707d42ca?w=400',
  ...
  const martin = await prisma.usuario.create({
    data: {
      ...
      avatar: 'https://images.unsplash.com/photo-1758598305480-176fb2ee4d5c?w=400',
  ...
  const julieta = await prisma.usuario.create({
    data: {
      ...
      avatar: 'https://images.unsplash.com/photo-1696535541700-cd11f1511bad?w=400',
  ...
  const facundo = await prisma.usuario.create({
    data: {
      ...
      avatar: 'https://images.unsplash.com/photo-1627397370714-e19ace8b3e73?w=400',
  ...
  const natalia = await prisma.usuario.create({
    data: {
      ...
      avatar: 'https://images.unsplash.com/photo-1656526010371-7b446afce0c6?w=400',
  ...
  const tomas = await prisma.usuario.create({
    data: {
      ...
      avatar: 'https://images.unsplash.com/photo-1674492053281-58ecccfeed4c?w=400',
  ...
  const e1 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1775242221619-a68c9fe85cd9?w=800',
      tipo: 'correr',
      nivelDificultad: 2,
  ...
  const e2 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1775380900491-ecbdd89cb657?w=800',
      tipo: 'ciclismo',
      nivelDificultad: 3,
  ...
  const e3 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1762652847106-a7e2dc128f12?w=800',
      tipo: 'encuentro',
      nivelDificultad: 1,
  ...
  const e4 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1763989979924-66d4b96c98bd?w=800',
      tipo: 'entrenamiento',
      nivelDificultad: 3,
  ...
  const e5 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1709607011653-add549f53691?w=800',
      tipo: 'yoga',
      nivelDificultad: 1,
  ...
  const e6 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1747133462919-ea91d748a2e2?w=800',
      tipo: 'senderismo',
      nivelDificultad: 2,
  ...
  const e7 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1749280447572-de42562eb4f4?w=800',
      tipo: 'social',
      nivelDificultad: 1,
  ...
  const e8 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1693948925468-2d439b24fb2c?w=800',
      tipo: 'correr',
      nivelDificultad: 2,
  ...
  const e9 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1715353111172-cb97186cf954?w=800',
      tipo: 'ciclismo',
      nivelDificultad: 4,
  ...
  const e10 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1759148177827-178181d82662?w=800',
      tipo: 'picnic',
      nivelDificultad: 1,
