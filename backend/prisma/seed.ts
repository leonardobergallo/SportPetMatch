...
async function main() {
  ...
  const e1 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1502904550040-7534597429ae?w=800',
      tipo: 'correr',
      nivelDificultad: 2,
  ...
  const e2 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1735216228027-fe31c23474ce?w=800',
      tipo: 'ciclismo',
      nivelDificultad: 3,
  ...
  const e3 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1506686267278-8d060af25de9?w=800',
      tipo: 'encuentro',
      nivelDificultad: 1,
  ...
  const e4 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1658314755811-73c806249f31?w=800',
      tipo: 'entrenamiento',
      nivelDificultad: 3,
  ...
  const e5 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1758274525887-d95d19269f76?w=800',
      tipo: 'yoga',
      nivelDificultad: 1,
  ...
  const e6 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1762045066237-b3b50d14047c?w=800',
      tipo: 'senderismo',
      nivelDificultad: 2,
  ...
  const e7 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1635634961004-8645e94cc175?w=800',
      tipo: 'social',
      nivelDificultad: 1,
  ...
  const e8 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1706459418431-f68031d1b006?w=800',
      tipo: 'correr',
      nivelDificultad: 2,
  ...
  const e9 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1649689071969-c0667209e42e?w=800',
      tipo: 'ciclismo',
      nivelDificultad: 4,
  ...
  const e10 = await prisma.evento.create({
    data: {
      ...
      imagenUrl: 'https://images.unsplash.com/photo-1758275557142-e4e5e7842d52?w=800',
      tipo: 'picnic',
      nivelDificultad: 1,
